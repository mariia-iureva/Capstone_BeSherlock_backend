!function(e, i) {
  ...
  function nextUnits(e, i) {
    ...
    return isRegionalIndicator(t) && isRegionalIndicator(r) || isFitzpatrickModifier(r) ? 4 : 2;
  }
  ...
  t[t.unit_2 = 2] = "unit_2", t[t.unit_4 = 4] = "unit_4", Object.defineProperty(runes, "runes", {
    ...
    value: n
  }), e.GRAPHEMS = n, e.betweenInclusive = betweenInclusive, e.codePointFromSurrogatePair = codePointFromSurrogatePair, 
  e.default = runes, e.isDiacriticalMark = isDiacriticalMark, e.isFirstOfSurrogatePair = isFirstOfSurrogatePair, 
  e.isFitzpatrickModifier = isFitzpatrickModifier, e.isGraphem = isGraphem, e.isRegionalIndicator = isRegionalIndicator, 
